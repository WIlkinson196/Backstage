  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1fr_380px]">
      <section className="backstage-panel rounded-3xl p-7">
        <div className="backstage-kicker">Commercial</div>
        <h2 className="backstage-display mt-2 text-4xl">Quote</h2>
        <p className="mt-3 max-w-3xl text-sm leading-6 text-black/45">Build the customer-facing quote from My Venue packages, guest numbers and extras.</p>
